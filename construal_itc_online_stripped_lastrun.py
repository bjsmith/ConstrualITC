...
expName = 'construal_itc_online_stripped'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/benjaminsmith/GDrive/neural-construal-level/code/SmithAdaptConstrualITC/construal_itc_online_stripped.psyexp',
...
for thisBlock in blocks:
    ...
    trials = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(("testdesign-"+blockSalienceCondition+".csv")),
    ...
    for thisTrial in trials:
        ...
        debugger.setText(blockSalienceCondition)
        # keep track of which components have finished
        itc_trialComponents = [Img_right_feedback, Img_left_feedback, ImgChoice2Background, ImgChoice1Background, Delay1, Delay2, Amount1, Amount2, resp, debugger, no_response, text_middle_line]
        ...
        while continueRoutine:
            ...
            if debugger.status == STARTED and t >= frameRemains:
                debugger.setAutoDraw(False)
