...
expName = 'construal_itc_basic2'  # from the Builder filename that created this script
expInfo = {u'participant': u'0', u'run_id': u'0', u'delay': u'mydelay', u'amount': u'myamount', u'timeout': u'0', u'day': u'0'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/benjaminsmith/GDrive/neural-construal-level/code/SmithAdaptConstrualITC/construal_itc_basic2.psyexp',
...
no_response_poly = visual.Rect(
    win=win, name='no_response_poly',
...
Delay1 = visual.TextStim(win=win, name='Delay1',
    text='First Delay',
    font='Arial',
    pos=(-0.8, 0.9), height=0.1, wrapWidth=None, ori=1.0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=-3.0);
Delay2 = visual.TextStim(win=win, name='Delay2',
    text='SecondDelay',
    font='Arial',
    pos=(0.8, 0.9), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=-4.0);
...
mystr=confirm_logicfile_access()

itc_feedback_duration=0.5
from itclogic import *

#code for the delay discounting itself
condition_to_use=choose_condition(expInfo['participant'], expInfo['run_id'], expInfo['day'])
#condition_to_use=choose_condition(1,1,1)
#generate from the subject ID, day, and run which to do
...
for thisBlock in blocks:
    ...
    for thisTrial in trials:
        ...
        # keep track of which components have finished
        itc_trialComponents = [no_response_poly, right_feedback, left_feedback, Delay1, Delay2, Amount1, Amount2, Choice1Background, Choice2Background, resp, debugger, no_response]
        ...
        while continueRoutine:
            ...
            # *no_response_poly* updates
            if ((False)) and no_response_poly.status == NOT_STARTED:
                # keep track of start time/frame for later
                no_response_poly.tStart = t
                no_response_poly.frameNStart = frameN  # exact frame index
                no_response_poly.setAutoDraw(True)
            ...
            debugger.text=str(condition_to_use)
