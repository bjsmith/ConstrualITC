...
expName = u'construal_itc_online'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/benjaminsmith/GDrive/neural-construal-level/code/SmithAdaptConstrualITC/construal_itc_online.psyexp',
...
Img_right_feedback = visual.ImageStim(
    ...
    image=u'images/blue-highlight-bg.png', mask=None,
...
Img_left_feedback = visual.ImageStim(
    ...
    image=u'images/red-highlight-bg.png', mask=None,
    ori=0, pos=(-0.5, 0), size=(0.3,0.2),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
blocks = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions(u'blockcontrol.csv'),
            ...
            if resp.status == STARTED:
                ...
                if len(theseKeys) > 0:  # at least one key was pressed
                    if resp.keys == []:  # then this was the first keypress
                        ...
                        # was this 'correct'?
                        if (resp.keys == str(u'"1"')) or (resp.keys == u'"1"'):
                            resp.corr = 1
                        else:
                            resp.corr = 0
