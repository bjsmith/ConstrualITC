...
expName = 'construal_itc_basic'  # from the Builder filename that created this script
expInfo = {u'delay': u'mydelay', u'amount': u'myamount', u'session': u'01', u'participant': u'', u'timeout': u'0'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/benjaminsmith/GDrive/neural-construal-level/code/SmithAdaptConstrualITC/construal_itc_basic.psyexp',
