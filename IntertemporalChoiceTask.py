...
class IntertemporalChoiceTask:
    ...
    def __init__(self,
        ...
        self.iti_fixeddelay_values = [5, 90]
    ...
    def populate_itc_task_with_parameters(self):
        ...
        if self.salience_condition == ItcSalienceCondition.Amount:
            ...
            self.task_data['SSdelay'] = pandas.Series([self.iti_fixeddelay_values[0]] * self.n_trials)
            ...
            self.task_data['LLdelay'] = pandas.Series([self.iti_fixeddelay_values[1]] * self.n_trials)
